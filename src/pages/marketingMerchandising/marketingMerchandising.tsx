  ...
  return (
    <div>
      ...
      <div className="columns-2">
        ...
        <h3>
          In my role as the Marketing and Merchandising Intern, I took charge of merchandising and sales. Additionally,
          I had the opportunity to observe and learn various marketing aspects within the unique context of a non-profit
          organization.
        </h3>
      </div>
