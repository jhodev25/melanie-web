  ...
  return (
    <div className="w-auto h-auto">
      ...
      <div className="bg-gray-500">
        <h3>
          Melanie was consistently responsive and engaging in her communication and collaboration as we shared creative
          vision and made design adjustments back and forth. She distinguished herself by creating an efficient and
          clear line of communication between the dealership and my company throughout this process.
        </h3>
        <h3>
        ...
        <h3>
          She was a pleasure to work with and demonstrated a good sense of what it means to work effectively as a team.
        </h3>
